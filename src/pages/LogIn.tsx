...
// import { login, userSlice, Adminlogin } from '../redux/slices/users/UserSlice'
...
import { loginThunk } from '../redux/slices/users/userSlice'
import { AppDispatch, RootState } from '../redux/store'
  ...
  return (
    <div>
      ...
      <form className="flex flex-col" onSubmit={handleSubmit}>
        ...
        <button>{users.isLoading ? 'Loging...' : 'Login'}</button>
      </form>
